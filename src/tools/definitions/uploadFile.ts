  ...
  parameters: {
    ...
    properties: {
      localPath: {
        type: "string",
        description:
          "Local file path to upload. Relative paths resolve inside the first open workspace folder. Absolute paths are accepted only inside that workspace. Sensitive workspace config/secret paths are rejected.",
      },
      bucket: {
        type: "string",
