...
`Discovered 11 compiled test file(s) for 11 source test file(s).` followed by `121 passing`.
If the compiled `out/src/test/suite/**/*.test.js` files are missing, `npm test` exits nonzero
instead of reporting `0 passing`.
