...
| --------------------------------- | ----- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Utils / Types                     | B     | Pure, small, well-tested helpers                                                                     | One upward import ([TD-1](exec-plans/tech-debt-tracker.md#td-1))                                                                                                                         |
...
| Harness (scripts / CI)            | A     | Extensive `assert-*` gates, audit policy, VSIX + release contracts, `npm run check` mirrors CI       | No layer/dependency linter yet ([TD-2](exec-plans/tech-debt-tracker.md#td-2))                                                                                                            |
| Docs (system of record)           | B     | `AGENTS.md` map + structured `docs/` now in place                                                    | No drift/staleness gate ([TD-3](exec-plans/tech-debt-tracker.md#td-3))                                                                                                                   |
